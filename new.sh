...
echo $i" |"$cy"     BRUTE-FORCE TERMUX HACKING"$i"         |"
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" MAZEEN AHAMED [MZN-KING]"$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" Mazeen Ahamed"$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ [MY USERS] [MY USERS] [MR.B]"$i"  |"
echo $i" |"$cy"            ~ [MZN-KING] [%ALL%] [Mazeen Ahamed]"$i" |"
echo $i" |"$pu" Contact WhatsApp :"$ku" 94771227821"$i"             |"
echo $i" |"$pu" Contact Gmail :"$ku" mazeenahamed23@gmail.com"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
...
echo $i"────────────────────────────────    ─────"
echo
echo $me"┌==="$bi"["$i"MZN-KING"$bi"]"$me"======"$bi"["$i""Pilih Nomornya""$bi"]"
echo $me"¦"
read -p"└──# " pil
...
sleep 2
echo $ku"WhatsApp :"$i" 94771227821"
echo $ku"Facebook :"$i" Mazeen Ahamed"
sleep 2
